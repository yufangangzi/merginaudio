var buttons ={
    ...
    l2:{ids:'btn2',L:'l1',R:'l3',T:'l2',D:'l2',Tlist:'l6',href:'',f:'ListFreeFocus',s:'ListSetFocus',e:'ListEnter2'},
...
var lu={
    ...
    getSpeaker:function () {
        ...
        navigator.getUserMedia({audio:true}, lu.onSuccess,lu.onError);
    },
    onSuccess:function (stream) {
        lu.mediaRecorder = new MediaRecorder(stream);
        lu.mediaRecorder.onstop = function (e) {
            console.log(lu.chunk)
            var blob = new Blob(lu.chunk, { 'type' : 'audio/wav; codecs=opus' }),
                url = window.URL.createObjectURL(blob);

            console.log(blob)

            merger.mergeSong('mp3/wuyufei.mp3',url)
...
var merger={
    ...
    saveKge:function () {
        ...
        document.getElementById('audio2').src=src;
